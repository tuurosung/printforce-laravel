...
<div wire:ignore.self id="{{ $modalId }}"
    {{ $attributes->merge(['class' => 'hs-overlay hs-overlay-open:opacity-100  hidden size-full fixed top-0 start-0 z-[80] opacity-0 overflow-x-hidden  overflow-y-auto pointer-events-none']) }}>
    <div
