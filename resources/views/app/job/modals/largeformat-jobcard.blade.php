        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex mb-3">
                    ...
                    <span class="fw-600">#LF{{ $largeFormatJob->sn }}</span>
                </div>
                <div class="d-flex">
                ...
                <table class=" table table-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ number_format($largeFormatJob->discount,2) }}</td>
                            <td class="fw-600 text-end">{{ number_format($largeFormatJob->total,2) }}</td>
                        </tr>
                        <tr>
                            <td colspan="6" class="text-end">Sub - Total (GHS)</td>
                            <td class="text-end">{{ number_format($largeFormatJob->total,2) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-end font-weight-bold" style="font-size:0.9rem">{{ number_format($largeFormatJob->total,2) }}</td>
                        </tr>
                    </tbody>
                </table>
