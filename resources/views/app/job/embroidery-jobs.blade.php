                        ...
                        <td class="text-end pe-20px">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="triggerId">
                                    <a href="#" class="viewjob dropdown-item me-3"
                                        data-url="{{ route('jobs.embroidery.show', $job->job_id) }}">

                                        <i class="fas fa-file-alt me-3 text-primary"></i>
                                        Job Card

                                    </a>
                                    <a href="#" class="job_card dropdown-item me-3" id="{{ $job->job_id }}">
                                    ...
                                    @can('administrator')
                                    <form method="POST" action="{{ route('jobs.embroidery.delete', $job->job_id) }}">
                                        @csrf
                                        @method('delete')
                                        <a href="#" class="dropdown-item delete_job"">
...
$(document).ready(function() {
    ...
    $('#filter_jobs_frm').on('submit', function(event) {
        ...
        var url = "{{ route('jobs.embroidery.filter') }}";
