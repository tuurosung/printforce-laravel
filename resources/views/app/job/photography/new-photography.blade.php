...
<div class="app-content">
    ...
    <div class="d-flex justify-content-center">
        ...
        <div class="col-6">
            ...
            <h4 class="montserrat fs-30px fw-600 mb-3">Photography Job</h4>
            ...
            <form id="" autocomplete="off" method="POST" action="jobs-controller/new-photography.php">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="browser-default custom-select" name="service_id" id="ph_service">
                                        <option value="">--- Select Service ---</option>
                                        <?php
                                        $list = $service->filterByCategory('005');  // Photography Category Code is '005
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control" name="cost" id="ph_cost" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="1" class="form-control" name="copies" id="ph_copies" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Total Cost</label>
                                    <input type="number" step="any" class="form-control" name="total" id="ph_total" readonly required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="">Notes (optional eg; Wedding Pictures)</label>
                            <input type="text" class="form-control" name="notes" id="ph_notes" value="">
                        </div>
        ...
        <script type="text/javascript">
            ...
            var service_cost = $('#ph_service').find(":selected").data('cost');
            $("#ph_cost").val(service_cost);
            ...
            $('#ph_service').on('change', function(event) {
            ...
            $("#ph_copies").on('keyup mouseup', function(event) {
                event.preventDefault();

                var copies = $('#ph_copies').val()
                copies = (copies === '' || isNaN(copies) || copies === 'undefined') ? 0 : parseInt(copies)

                var cost = $('#ph_cost').val()
                cost = (cost === '' || isNaN(cost) || cost === 'undefined') ? 0 : parseFloat(cost)

                $('#ph_total').val((copies * cost).toFixed(2))
            });
        </script>
