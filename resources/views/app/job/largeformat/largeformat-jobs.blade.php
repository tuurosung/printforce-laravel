...
<x-headers.top-header pageTitle="Large Format Jobs">
                            ...
                            <div class="row flex-nowrap mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <x-cards.colour-card2 title="This Years Jobs" colour="success"
                                        :value="$statistics['this_years_jobs_total']" icon="users" valueType="number" />

                                </div>
                                <div class="col">

                                    <x-cards.colour-card2 title="Revenue %" colour="warning" value="0"
                                        icon="chart-simple" valueType="number" />
                            ...
                            <div class="me-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="start_date"
                                        id="start_date" value="{{ now()->format('Y-m-d') }}" />
                                </div>
                            ...
                            <div class="me-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="end_date"
                                        id="end_date" value="{{ now()->format('Y-m-d') }}" />
                                </div>
