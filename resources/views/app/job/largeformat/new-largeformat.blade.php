    ...
    <div
        ...
        <div
            ...
            <div class="flex justify-between items-center py-3 px-6 border-b border-border dark:border-gray-700">
                ...
                <h3 class="text-base font-cal-sans-regular text-gray-800 dark:text-white">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control py-2.5 px-4" name="service_id" id="largeformat_service_id"
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control py-2.5 px-4" name="cost" id="largeformat_cost"
                                            readonly required />
                                    </div>
                        ...
                        <section class="mb-8">
                            ...
                            <div class="grid grid-cols-4 gap-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control py-2.5 px-4" name="width" id="width"
                                        required />
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Height</label>
                                    <input type="number" step="any" class="form-control py-2.5 px-4" name="height" id="height" required />
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Unit Of Measurement</label>
                                    <select class="form-control py-2.5 px-4" name="measuring_unit" id="measuring_unit" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control py-2.5 px-4" name="copies" id="largeformat_copies" placeholder="Number of Copies"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-4 gap-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control py-2.5 px-4" name="sub_total" id="largeformat_sub_total"
                                        readonly required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="any" class="form-control py-2.5 px-4" name="discount"
                                        id="largeformat_discount" value="0" required>
                                </div>

                                <div class="mb-3">
                                    <label for="" class="form-label">Premium</label>
                                    <input type="number" step="any" class="form-control py-2.5 px-4" name="premium"
                                        id="largeformat_premium" value="0" required>
                                </div>

                                <div class="mb-3">
                                    <label for="" class="form-label">Total Cost</label>
                                    <input type="text" class="form-control py-2.5 px-4" name="total" id="largeformat_total" readonly
                                        required />
                                </div>
                            </div>
                        </div>
