...
<?php require_once '../serverscripts/Classes/Jobs.php'; ?>
<?php require_once '../serverscripts/Classes/Customers.php'; ?>
<?php
    $job_id=clean_string($_GET['job_id']);
    $j=new Job($q->db, $q->mysqli);
    $j->job_id=$job_id;
    $j->JobInfo();
    $j->ServiceInfo($j->service_id);
...
<div class="container">
  <div class="font-weight-bold montserrat" style="font-weight:bold; margin:1rem 0rem 1rem; font-size:1rem">JOB CARD</div>


  <div class="" style="font-size:12px">
    <div class="d-flex mb-1" style="display:flex;">
        <div style="width:90px">Job ID:</div>
        <div class="font-weight-bold montserrat"><strong><?php echo $j->job_id; ?></strong></div>
    </div>
    <div class="d-flex mb-1" style="display:flex">
    ...
    <div class="d-flex mb-0"  style="display:flex">
        ...
        <div class="font-weight-bold montserrat"><strong><?php echo $j->date; ?></strong></div>
    </div>
  </div>


  <h3 class="montserrat font-weight-bold"><?php echo $j->service_name; ?></h3>
  <div class="mt-3" style="margin-top:30px">
    <hr class="mb-2" style="border-top:dashed 1px #000">

    <div class="row font-weight-bold Poppins" style="font-size:14px; display:flex;">
