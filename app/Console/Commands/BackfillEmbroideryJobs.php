...
#[Signature('app:backfill-embroidery-jobs')]
#[Description('Command description')]
class BackfillEmbroideryJobs extends Command
{
    protected const  JOBTYPE = 'embroidery';
    protected const SOURCETABLE = 'jobs_embroidery';
                ...
                DB::table(self::SOURCETABLE)
                    ...
                    ->chunk(1000, function ($rows) use ($bar) {
                        ...
                        $insert = $rows->map(fn($row) => [
                            ...
                            'qty' => $row->qty,
                            'sub_total' => $row->embroidery_cost ?? 0,
