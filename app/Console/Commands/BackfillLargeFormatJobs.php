...
#[Signature('app:backfill-largeformat-jobs')]
#[Description('Command description')]
class BackfillLargeFormatJobs extends Command
{
    protected const  JOBTYPE = 'large_format';
    protected const SOURCETABLE = 'jobs_largeformat';
