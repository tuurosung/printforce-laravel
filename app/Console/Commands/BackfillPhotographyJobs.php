...
#[Signature('app:backfill-photography-jobs')]
#[Description('Command description')]
class BackfillPhotographyJobs extends Command
{
    protected const  JOBTYPE = 'photography';
    protected const SOURCETABLE = 'jobs_photography';
