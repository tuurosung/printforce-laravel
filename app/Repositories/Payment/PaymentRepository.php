...
use App\Contracts\Payments\PaymentServiceContract;
...
class PaymentRepository implements PaymentServiceContract
{
    /**
    ...
    abstract public function create(array $data): CustomerPayment;
}
